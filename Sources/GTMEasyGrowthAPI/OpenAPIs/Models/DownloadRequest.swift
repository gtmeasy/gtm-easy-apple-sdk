...
public struct DownloadRequest: Codable, JSONEncodable, Hashable {
    ...
    public private(set) var source: String? = "website"
    ...
    public init(app: String? = nil, environment: Environment? = .production, platform: Platform? = nil, userId: String? = nil, anonymousId: String? = nil, deviceId: String? = nil, appVersion: String? = nil, buildNumber: String? = nil, source: String? = "website", country: String? = nil, locale: String? = nil, timezone: String? = nil, attributionProvider: String? = nil, attributionId: String? = nil, occurredAt: Date? = nil, properties: [String: AnyCodable]? = nil) {
        self.app = app
